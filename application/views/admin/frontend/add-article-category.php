              ...
              <div class="box-body">
                ...
                <div class="col-md-8">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="alias_category" value="<?php echo set_value('alias_category') ?>" class="form-control">
                  </div>
                  <div class="form-group">
                    <label for="">Deskripsi</label>
                    <textarea name="description" id="textarea" placeholder="Deskripsikan tentang kategori"><?php echo set_value('description') ?></textarea>
                  </div>
                  <div class="form-group">
