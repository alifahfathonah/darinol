                ...
                <div class="row">
                  <div class="col-md-2">
                    <a class="btn btn-primary " style="margin:10px 0 10px 10px" href="<?php echo base_url($this->uri->segment(1).'/frontend/manage-slider/')?>" role="button">
                        <i class="fa fa-list fa-fw" ></i> Ubah Slider
                      </a>
                  </div>
                </div>
              </div>
              ...
              <div class="box-body">
                ...
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <input type="text" name="title_slider" value="<?php echo $result['title_slider'] ?>" class="form-control">
                  </div>
                    <div class="form-group">
                      <label for="">Link / URL*</label>
                      <input type="text" name="url_slider" value="<?php echo $result['url_slider'] ?>" class="form-control">
                    </div>
                  <div class="form-group">
                    <label for="">Urutan*</label>
                    <input type="number" name="sort_order" value="<?php echo $result['sort_order'] ?>" class="form-control" min=1>
                  </div>
                  <div class="form-grop" style="margin-bottom:25px;">
                    <label for="imageClass">Gambar Slider (max: 2Mb)</label><br>
                    <img src="<?php echo base_url($result['image_slider']) ?>" alt="" style="height:150px;">
